...
![Navigate into fact sheets](./media/AdminPanel.png)

On the left side of the screen **insert a name** for the fact sheet and click on **New**.

![Create new fact sheet](./media/NewFactSheet.png)

![Create new fact sheet](./media/CreatedFactSheet.png)
...
![Fill the Detailcontent](./media/ChoosingFacetforFactSheet.png)
...
![Choose from dropdown list](./media/Dropdown.png)

![Result from dropdown list](./media/Result.png)
...
![Text widget options](./media/TextWidget.png)
...
![List widget options](./media/ListWidget.png)
...
![Picture widget options](./media/PictureWidget.png)
